...
// impl Default for MeasurementWindowConfiguration<ThreeLedsMode> {
//     fn default() -> Self {
//         MeasurementWindowConfiguration {
//             period: Time::new::<microsecond>(10_000.0),
//             active_timing_configuration: ActiveTiming::ThreeLeds {
//                 led2: LedTiming {
...
impl Default for LedTiming {
    fn default() -> Self {
        LedTiming {
            ...
            sample_st: Time::new::<microsecond>(0.0),
            sample_end: Time::new::<microsecond>(0.0),
            reset_st: Time::new::<microsecond>(0.0),
            reset_end: Time::new::<microsecond>(0.0),
            conv_st: Time::new::<microsecond>(0.0),
            conv_end: Time::new::<microsecond>(0.0),
        }
    }
}
...
impl Default for AmbientTiming {
    fn default() -> Self {
        AmbientTiming {
            sample_st: Time::new::<microsecond>(0.0),
            sample_end: Time::new::<microsecond>(0.0),
