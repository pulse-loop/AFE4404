...
impl<I2C> AFE4404<I2C>
    ...
    pub fn set_tia_resistors(&mut self, resistor1: ElectricalResistance, resistor2: ElectricalResistance) -> Result<[u16; 2], ()> {
        let r20h_prev = self
            .registers
            .r20h
            .read()?;
    ...
    pub fn set_tia_capacitors(&mut self, capacitor1: Capacitance, capacitor2: Capacitance) -> Result<[u16; 2], ()> {
        let r20h_prev = self
            .registers
            .r20h
            .read()?;
